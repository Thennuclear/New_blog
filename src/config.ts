...
export const siteConfig: SiteConfig = {
	title: "Enucleare's blog",
	subtitle: "一个摆烂的博客",
	siteURL: "https://thenuclear.online/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1186486", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "Steam",
					url: "https://steamcommunity.com/id/Enucleare/",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "此网站将会在30天内迁移到enucleare.online", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://www.thenuclear.online/api?server=netease&type=playlist&id=7249478506", // Meting API 地址
	id: "7249478506", // 歌单ID
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/yuri/Yuri.model.json"], // 默认模型路径
	...
	dialog: {
		...
		close: "继续踏上这无意义的旅行", // 关闭提示
		link: "/posts/post2_about_me/", // 关于链接
	},
};
